...
cc.Class({
    ...
    onLoad () {
        ...
        this.node.on('victory', this.victory, this);
    ...
    start () {
        this.mode = 'a';
        this.schedule(this.spawnNewEnermy, 5);
        this.spawnNewAlli(1);
    },
    ...
    spawnNewEnermy: function() {
        ...
        newEnermy.setPosition(x-25, 300);
        newEnermy.emit('setID', id);
    },
    ...
    victory: function() {
        cc.director.pause();
        var btn = cc.instantiate(this.victoryBtn);
        this.node.addChild(btn);
        //btn.setPosition(0,0);
    },
